...
data class Message(
    ...
    companion object {
        ...
        fun event(
            ...
            eventType: String,
            data: Any,
        ): Message = Message(channel = channel, eventType = eventType, data = data)
        ...
        fun withMeta(
            ...
            data: Any,
            meta: Map<String, Any>,
        ): Message = Message(channel = channel, data = data, meta = meta)
        ...
        ): Message = Message(channel = channel, data = data, transports = transports)
        ...
        fun webSocketOnly(
            channel: String,
            data: Any,
        ): Message = Message(channel = channel, data = data, transports = listOf(Transport.WebSocket))
        ...
        fun httpStreamOnly(
            channel: String,
            data: Any,
        ): Message = Message(channel = channel, data = data, transports = listOf(Transport.HttpStream))
        ...
        fun sseOnly(
            channel: String,
            data: Any,
        ): Message = Message(channel = channel, data = data, transports = listOf(Transport.HttpStreamSSE))
        ...
        fun withIds(
            ...
            id: String,
            prevId: String? = null,
        ): Message = Message(channel = channel, data = data, id = id, prevId = prevId)
     ...
     */
    fun withEventType(newEventType: String): Message = copy(eventType = newEventType)

    /**
     * Creates a copy of this message with different transports.
     */
    fun withTransports(newTransports: List<Transport>): Message = copy(transports = newTransports)
    ...
    fun withIds(
        id: String,
        prevId: String? = null,
    ): Message = copy(id = id, prevId = prevId)
}
