...
dependencies {
    ...
    implementation("io.github.mpecan:pushpin-client:0.0.3")
    implementation("io.github.mpecan:pushpin-transport-http:0.0.3")
    implementation("io.github.mpecan:pushpin-security-jwt:0.0.3")
    implementation("io.github.mpecan:pushpin-security-encryption:0.0.3")
}
```
...
dependencies {
    ...
    implementation("io.github.mpecan:pushpin-client:0.0.3")
    implementation("io.github.mpecan:pushpin-transport-http:0.0.3")
    implementation("io.github.mpecan:pushpin-discovery-aws:0.0.3")
}
```
...
dependencies {
    ...
    implementation("io.github.mpecan:pushpin-client:0.0.3")
    implementation("io.github.mpecan:pushpin-transport-http:0.0.3")
    implementation("io.github.mpecan:pushpin-discovery-kubernetes:0.0.3")
}
```
...
dependencies {
    implementation("io.github.mpecan:pushpin-api:0.0.3")
    implementation("io.github.mpecan:pushpin-client:0.0.3")
    implementation("io.github.mpecan:pushpin-transport-zmq:0.0.3")
}
```
