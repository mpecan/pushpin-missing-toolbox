 ...
 * 
 * This class provides convenient methods for implementing GRIP (Generic Realtime 
 * Intermediary Protocol) in your Spring Boot applications with Pushpin.
 * 
 * ## Basic Usage
 * 
 * ### HTTP Long-Polling
...
object GripApi {
     ...
     */
    fun <T> longPollingResponse(channel: String, timeout: Int = GripConstants.DEFAULT_TIMEOUT): ResponseEntity.BodyBuilder {
     ...
     */
    fun applyMetaHeaders(builder: ResponseEntity.BodyBuilder, metaHeaders: Map<String, String>): ResponseEntity.BodyBuilder {
